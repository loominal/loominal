...
### Step 1: Setup
```
Use set_handle with handle: "worker-b"
...
Fill in the "Worker B Results" section with:
...
Also update the "Task Distribution" table in the Aggregate Analysis section - for each task you claimed, write "Worker B" in the "Claimed By" column.

## Critical Instructions
- Record EVERY task ID you receive
- Note if you get any duplicate task IDs (this would be a BUG)
- Note if you get a task ID that Worker A also claims (check results.md)
- Count your total successfully claimed tasks

## Success Criteria
- [ ] Claimed approximately 2 tasks (±1)
- [ ] All claimed tasks have unique IDs
- [ ] No overlap with Worker A's tasks
